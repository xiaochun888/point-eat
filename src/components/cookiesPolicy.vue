...
<div class="cookies-policy container">
  ...
  <h2>Pourquoi utilisons-nous ces technologies?</h2>
  <p>Nous plaçons des cookies, des trackers et des scripts pour des raisons différentes notamment&nbsp;: des objectifs fonctionnels, analytiques et de marketing. Vous trouverez ci-dessous un aperçu des différents objectifs de l’usage des technologies. Pour un aperçu spécifique de toutes les technologies utilisées par nos soins, les objectifs liés et les fonctions spécifiques des technologies, nous renvoyons volontiers à notre liste de technologies. Cette liste est régulièrement adaptée par nos soins pour donner un aperçu aussi précis que possible des technologies utilisées par nos soins.</p>
  <br>
  ...
  <br>
  <br>
  <h2>Sécurisation de vos données par nous et par les tiers</h2>
  <p>1. <i>Sécurisation de vos données par Point Eat</i></p>
  <p>Point Eat prend la protection de vos données très au sérieux et prend les mesures adaptées pour contrer tout abus, perte, accès indésirable, divulgation non souhaitée et modification interdite. Si vous avez l’impression que vos données ne sont cependant pas bien sécurisées ou soupçonnez un abus quelconque, prenez alors contact avec nous&nbsp;: <a href="mailto:contact@point-eat.fr">contact@point-eat.fr</a>.</p>
  ...
  Nous concluons avec les tiers qui placent des technologiques sur notre site web des contrats de transformation pour garantir un niveau identique de sécurité et de confidentialité de vos données. Nous restons responsables du traitement de vos données à caractère personnel à la demande de Point Eat.
  </p>
  <br>
  <br>
  ...
  <p>
  Vous avez le droit de demander à accéder à vos données, à les corriger ou les éliminer (pour plus d'information, voir notre déclaration en matière de vie privée. Pour éviter tout abus, nous pouvons vous demander de vous identifier de manière adéquate en cas de requête de ce type.
  </p>
  <p>3. <i>Conseils, questions et réclamations</i></p>
  <p>
  Pour plus d’information sur la manière dont nous traitons vos données à caractère personnel, nous renvoyons volontiers à notre déclaration en matière de vie privée. Si vous avez des questions ou des réclamations relatives à notre politique en matière de cookie, nous vous répondrons volontiers.
  </p>
